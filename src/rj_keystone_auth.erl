...
authorize(RequestData) ->
	PermittedRoles = rj_http_config:keystone_permitted_roles(),
...
retrieve_admin_token() ->
	RequestURI = rj_http_config:keystone_token_url(),
	Username = rj_http_config:keystone_admin_username(),
	Password = rj_http_config:keystone_admin_password(),
	TenantName = rj_http_config:keystone_tenant(),
...
request_keystone_token_info(AuthToken) ->
	AuthURI = rj_http_config:keystone_token_url(),
